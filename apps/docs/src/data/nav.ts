...
export const DOCS_NAV: readonly NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'require-image-dimensions', href: '/docs/rules/require-image-dimensions' },
      { label: 'no-blocking-script', href: '/docs/rules/no-blocking-script' },
      { label: 'no-unprocessed-script-surprises', href: '/docs/rules/no-unprocessed-script-surprises' },
      { label: 'no-missing-alt', href: '/docs/rules/no-missing-alt' },
      { label: 'no-missing-lang', href: '/docs/rules/no-missing-lang' },
      { label: 'require-island-fallback', href: '/docs/rules/require-island-fallback' },
      { label: 'no-set-html', href: '/docs/rules/no-set-html' },
      { label: 'no-public-secret-env', href: '/docs/rules/no-public-secret-env' },
